...
const PLANS = [
  {
    ...
    features: ['30 AI credits (~3 auto-prospect runs)', '1 seat', 'Basic AI research', 'SMTP sending', '1 mailbox'],
  ...
  },
  {
    ...
    features: ['500 AI credits (~50 auto-prospect runs)', '1 seat', 'Deep research', 'SMTP + Smartlead', 'Email enrichment', 'Follow-up sequence', '3 mailboxes'],
  ...
  },
  {
    ...
    features: ['2,000 AI credits (~200 auto-prospect runs)', '5 seats', 'Manager dashboard', 'Analytics + team leaderboard', 'Multi-mailbox rotation', 'Cal.com meeting tracking', 'Priority support'],
  ...
  },
  {
    ...
    features: ['8,000 AI credits (~800 auto-prospect runs)', '3 SDR seats included', 'Role-based access control', 'White-label option', 'API access', 'Dedicated success manager', 'Extra seats: $30/mo each'],
